    ...
    children: [
      ...
      new Paragraph({
        ...
        children: [
          ...
          new TextRun({
            text: `, ${data.nacionalidade ? data.nacionalidade.toLowerCase() : ""}, ${data.estadoCivil ? data.estadoCivil.toLowerCase() : ""}, ${data.profissao ? data.profissao.toLowerCase() : ""}, regularmente inscrito no CPF sob o nº ${data.cpf}, residente e domiciliado(a) na ${data.endereco}, CEP: ${data.cep}, na cidade de ${data.cidade}/${data.estado}, de ora em diante denominado apenas ASSOCIADO.`,
          }),
        ],
        spacing: { after: 200 },
      }),
